...
| **Phạm Quang Huy**  | B21DCCN439   | Backend: Quản lý sản phẩm (CRUD sản phẩm, danh mục, combo). Frontend: Giao diện menu, Giao diện chi tiết sản phẩm, Giao diện quản lí sản phẩm cho admin (crud)                                            |
